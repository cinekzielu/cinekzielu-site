...
const tatryUiLayout = {
  ...
  koscielec: { nudge: { x: 1.1, y: -1.1 }, labelOffset: { x: -14, y: -7 }, tier: 'secondary' },
  krywan: { nudge: { x: -0.6, y: 0.6 }, labelOffset: { x: -16, y: 10 }, tier: 'primary' },
  lomnica: { nudge: { x: 0.6, y: 0.1 }, labelOffset: { x: 8, y: -8 }, tier: 'primary' },
  gerlach: { nudge: { x: 1.1, y: -0.9 }, labelOffset: { x: 10, y: -12 }, tier: 'featured' },
  'durny-szczyt': { nudge: { x: 1.8, y: -1.2 }, labelOffset: { x: -30, y: 9 }, tier: 'secondary' },
  'lodowy-szczyt': { nudge: { x: 0.1, y: -0.5 }, labelOffset: { x: 14, y: -10 }, tier: 'primary' },
  'baranie-rogi': { nudge: { x: 0.9, y: -0.6 }, labelOffset: { x: 13, y: -2 }, tier: 'secondary' },
  'kiezmarski-szczyt': { nudge: { x: 1.5, y: -0.4 }, labelOffset: { x: 13, y: 9 }, tier: 'primary' },
  konczysta: { nudge: { x: -0.3, y: 0.4 }, labelOffset: { x: -16, y: 10 }, tier: 'secondary' },
  rysy: { nudge: { x: 0.2, y: -0.4 }, labelOffset: { x: -14, y: -10 }, tier: 'featured' },

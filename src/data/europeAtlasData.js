export const europeAtlasNodes = [
  ...
  { id: 'poland', label: 'Polska', code: 'PL', type: 'country', status: 'active', shortDescription: 'Punkt wyjściowy atlasu i jedno z wejść do regionu Tatry.', panelDescription: 'Aktywny kraj bazowy z bezpośrednim przejściem do regionu Tatry.', position: { x: 334, y: 126, chipWidth: 104 }, labelOffset: { x: 24, y: -18 }, panelTags: ['Aktywne', 'Tatry', 'Galerie'], routeTarget: null },
  { id: 'slovakia', label: 'Słowacja', code: 'SK', type: 'country', status: 'active', shortDescription: 'Południowa strona Tatr i kluczowy kraj graniczny atlasu.', panelDescription: 'Aktywny kraj graniczny współtworzący oś wypraw tatrzańskich.', position: { x: 348, y: 164, chipWidth: 112 }, labelOffset: { x: 26, y: 20 }, panelTags: ['Aktywne', 'Tatry', 'Wyprawy'], routeTarget: null },
  { id: 'switzerland', label: 'Szwajcaria', code: 'CH', type: 'country', status: 'visited', shortDescription: 'Alpejski kierunek z rozwijającą się galerią i materiałami filmowymi.', panelDescription: 'Kraj odwiedzony, alpejski materiał foto/film jest już częścią atlasu.', position: { x: 228, y: 201, chipWidth: 124 }, labelOffset: { x: -40, y: 22 }, panelTags: ['Odwiedzone', 'Alpy', 'Galeria'] },
  { id: 'austria', label: 'Austria', code: 'AT', type: 'country', status: 'visited', shortDescription: 'Kraj alpejski z trasami wysokogórskimi i bazą pod kolejne relacje.', panelDescription: 'Kraj odwiedzony, przygotowany pod dalszy rozwój alpejskiej osi.', position: { x: 306, y: 204, chipWidth: 104 }, labelOffset: { x: 6, y: 26 }, panelTags: ['Odwiedzone', 'Alpy', 'Film + foto'] },
  { id: 'germany', label: 'Niemcy', code: 'DE', type: 'country', status: 'planned', shortDescription: 'Kierunek przejściowy i zaplecze logistyczne pod kolejne wyprawy.', panelDescription: 'Kraj planowany jako zaplecze i rozszerzenie Europy Środkowej.', position: { x: 271, y: 130, chipWidth: 102 }, labelOffset: { x: -34, y: -22 }, panelTags: ['W planach', 'Galeria wkrótce', 'Przyszły kierunek'] },
  ...
  { id: 'liechtenstein', label: 'Liechtenstein', code: 'LI', type: 'microstate', status: 'planned', shortDescription: 'Mały kraj alpejski przewidziany jako punkt specjalny atlasu.', panelDescription: 'Mikropaństwo planowane jako subtelny punkt premium w osi alpejskiej.', position: { x: 256, y: 181, chipWidth: 132 }, labelOffset: { x: -58, y: -30 }, panelTags: ['Microstate', 'W planach', 'Alpy'] },
  { id: 'tatry', label: 'Tatry', code: 'TAT', type: 'region', status: 'active', shortDescription: 'Aktywny region specjalny między Polską i Słowacją.', panelDescription: 'Aktywny region specjalny z ikoną gór i przejściem do widoku Tatr.', position: { x: 356, y: 142, chipWidth: 96 }, panelTags: ['Aktywny region', 'Przejście do mapy Tatr', 'Oś wypraw'], routeTarget: 'tatry' },
]
